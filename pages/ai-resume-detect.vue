...
✅ 優點：
• 擁有3年專業教學經驗，服務過70位以上客戶
• 具備NSCA-CPT國際認證和KAT脊柱力學優化專業證照
• 學歷背景相關：國立台北大學休閒運動管理學系
• 有具體成功案例（如協助學員3個月減重6公斤，體脂30%→24%）
• 專精多領域：增肌減脂、體態雕塑、銀髮族體適能

⚠️ 需要注意：
• 轉職動機需進一步了解（從健身教練轉向前端工程師）
• 程式開發經驗相對較新，實務專案經驗需確認
• 可以詢問學習能力和適應科技業環境的準備度

整體來說，候選人展現出學習熱忱和專業態度，建議面試了解轉職規劃。`;
  }
...
🔸 專業技能轉換：
• 從健身教練轉向前端開發的動機是什麼？如何規劃這個轉職過程？
• 您如何將運動管理的經驗運用到程式開發工作中？

🔸 學習能力：
• 請分享您自學程式設計的過程，遇到哪些挑戰？如何克服？
• 您的作品集中最滿意的專案是什麼？能否詳細介紹開發過程？

🔸 職涯規劃：
• 您期待在軟體工程師這個職位上獲得什麼樣的成長？
• 如何平衡目前的教練工作與未來的程式開發職涯？

這些問題可以幫您評估候選人的轉職決心和學習能力。`;
  }
