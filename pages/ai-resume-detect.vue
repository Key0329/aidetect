...
const cardSummary = ref({
  recommendation: "需關注問題", // 高度推薦 | 需關注問題
  jobMatch: {
    position: "前端工程師",
    strengths: ["服務業溝通經驗", "自我學習能力強"],
    resumeHighlights: ["3年私人教練經驗", "台北大學休閒運動管理學系"],
  },
  concerns: {
    areas: ["程式開發經驗較少", "轉職動機需確認"],
    source: "職涯轉換分析",
  },
});
...
const getPresetResponse = (message) => {
  ...
  if (message.includes("分析這份履歷的優缺點")) {
    return `看完翔駿的履歷，我有一些想法想跟您分享～

✨ 讓我眼睛一亮的地方：
• 哇！3年來服務過70位以上客戶，這數字真的很亮眼呢
• 有NSCA-CPT這樣的國際認證，可以看出他對專業的要求
• 台北大學休閒運動管理系的背景，學歷也很不錯
• 最棒的是有具體成果！幫學員3個月瘦了6公斤，體脂從30%降到24%
• 從增肌減脂到銀髮族體適能都有涉獵，適應力應該不錯

🤔 需要我們多留意的部分：
• 從健身教練跨到前端工程師，這轉換蠻大的，建議聊聊他的想法
• 程式開發的實戰經驗可能還在累積中，可以問問他的學習狀況
• 對科技業的工作節奏和文化，可能需要時間適應

整體感覺，翔駿是個很有學習動力的人！建議安排面試好好聊聊，我覺得他的轉職故事會很有趣 😊`;
  }

  if (message.includes("建議適合的面試問題")) {
    return `好的！我幫您想了一些問題，希望能幫您更了解翔駿這個人 ☺️

💭 關於轉職的故事：
• 「是什麼讓您決定從健身教練轉向程式開發？這個決定對您來說意味著什麼？」
• 「您覺得健身教練的經驗，有哪些部分可以幫助您在程式開發上做得更好？」

🌱 關於學習的旅程：
• 「可以跟我們分享一下您自學程式的過程嗎？最有挑戰的部分是什麼？」
• 「您的作品集裡有哪個專案是您最驕傲的？背後有什麼故事呢？」

🚀 關於未來的想像：
• 「您對軟體工程師這個角色有什麼期待？希望在這裡學到什麼？」
• 「目前還有在做教練工作嗎？您打算如何安排時間呢？」

這些問題比較輕鬆，可以讓候選人放鬆地分享他的想法，您也能從中看出他的個性和動機 💪`;
  }

  if (message.includes("評估候選人的適合度")) {
    return `讓我幫您分析一下翔駿的適合度，我的直覺是這樣的：

🌟 學習熱忱：85分
• 能主動轉職真的需要很大勇氣！這點我很欣賞
• 看得出來他在程式學習上投入了不少心力

💼 職場素養：70分  
• 做過健身教練，溝通能力應該不錯（要能激勵客戶嘛）
• 這個工作需要很多耐心跟責任感，我覺得這些特質很棒
• 不過技術經驗確實還在起步階段

🚀 發展空間：80分
• 年輕人嘛，學習能力通常都不錯
• 運動背景的人思維可能比較不一樣，說不定會帶來新想法
• 看起來是個很有自制力的人

💡 我的綜合感覺：78分
建議您安排面試聊聊！我覺得最重要的是看他的學習態度和轉職決心是不是真的夠堅定 😊`;
  }

  if (message.includes("薪資談判建議")) {
    return `關於薪資這塊，我來跟您分享一些想法～

💰 市場行情我幫您查了一下：
• 新手前端工程師大概 50-80萬年薪
• 像翔駿這樣轉職的，起薪可能在 45-65萬
• 他有大學學歷，可以稍微加個 5-10%

💬 談判時可以這樣聊：
• 多強調「這裡能學到什麼」，轉職的人最在乎這個
• 可以提到會有教育訓練或找前輩帶他
• 如果有實習期或導師制度，記得說一下
• 介紹團隊氣氛和工作環境，他應該會很重視

🤗 小提醒：
• 轉職的人通常願意為了學習機會犧牲一點薪水
• 可以多談未來發展和升遷機會
• 他現在可能還有教練工作，時間安排可能需要討論
• 重點是讓他感受到公司的支持和成長空間

我覺得重點不是薪水談多少，而是讓他知道這裡是個好的學習環境！😊`;
  }

  // 關鍵字回應
  if (lowerMessage.includes("履歷") || lowerMessage.includes("resume")) {
    return "履歷分析我最拿手了！😊 我可以幫您看看候選人的優缺點、分析適合度，或是給一些改進建議。您想了解翔駿履歷的哪個部分呢？";
  }

  if (lowerMessage.includes("面試") || lowerMessage.includes("interview")) {
    return "面試的事情交給我吧！我可以協助您：\n• 💡 設計貼近候選人背景的面試問題\n• 🎯 提供面試技巧和注意事項\n• 📝 幫您分析候選人的回答\n• ✨ 評估整體面試表現\n\n您最希望我在哪方面幫您呢？";
  }

  if (lowerMessage.includes("薪資") || lowerMessage.includes("salary")) {
    return "薪資談判也是我的專長呢！✨ 我可以分享市場行情、給您一些談判小技巧，或是幫您設計薪資結構。您想了解哪個部分？";
  }

  if (lowerMessage.includes("招募") || lowerMessage.includes("recruit")) {
    return "招募這塊我很有經驗！😄 我可以陪您：\n• 📋 寫出吸引人的職缺描述\n• 🎯 制定有效的招募策略\n• 👥 協助篩選合適的候選人\n• 🔄 優化整個招募流程\n\n目前在招募上有遇到什麼挑戰嗎？我們一起想辦法！";
  }

  // 預設友善回應
  const defaultResponses = [
    "嗨～很開心跟您聊天！😊 我是您的人資小助手，履歷分析、面試規劃、薪資建議這些我都能幫忙。有什麼想討論的嗎？",
    "您好呀！我是專門陪伴人資夥伴的 AI 助手 ✨ 履歷怎麼看、面試怎麼問、招募怎麼做，我們一起來想辦法！有什麼我可以協助的嗎？",
    "哈囉！很高興能為您服務 🌟 人資工作有時候真的不容易，不過別擔心，我會一直在這裡陪著您！不管是招募還是人才管理，都可以跟我聊聊～",
  ];
